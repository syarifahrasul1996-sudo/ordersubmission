  ...
  return (
    <div className="flex flex-col p-4 sm:p-5 space-y-3 pb-[calc(env(safe-area-inset-bottom)+5rem)]">
      <button 
        ...
        className="h-[58px] bg-primary text-white font-black text-[15px] sm:text-[16px] rounded-[16px] flex items-center justify-center w-full shadow-lg shadow-primary/20 active:scale-[0.98] transition-transform"
      >
      ...
      <button 
        ...
        className="h-[58px] bg-white border-[1.5px] border-primary text-primary font-black text-[15px] sm:text-[16px] rounded-[16px] flex items-center justify-center w-full active:scale-[0.98] transition-transform"
      >
