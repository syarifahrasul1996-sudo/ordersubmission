...
export function FloatingControls() {
  ...
  return (
    <div className="fixed md:absolute bottom-[calc(env(safe-area-inset-bottom)+0.15rem)] left-4 right-4 sm:left-5 sm:right-5 bg-white/95 backdrop-blur-2xl border border-gray-100 p-3 flex gap-2 sm:gap-3 z-50 transition-none rounded-[20px] shadow-[0_8px_30px_rgba(0,0,0,0.12)]">
      <button 
