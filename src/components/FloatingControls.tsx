...
export function FloatingControls() {
  ...
  return (
    <div className="fixed md:absolute bottom-[calc(env(safe-area-inset-bottom)+5.5rem)] md:bottom-4 left-4 right-4 md:left-5 md:right-5 bg-white/95 backdrop-blur-2xl border border-gray-100 p-3 flex gap-2 sm:gap-3 z-[60] transition-all duration-300 rounded-[20px] shadow-[0_8px_30px_rgba(0,0,0,0.12)]">
      <button 
