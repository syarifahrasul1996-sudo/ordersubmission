  ...
  return (
    <div
      ...
      className={cn(
        ...
        "bg-[#1C1C1E] text-white px-6 sm:px-8 py-3.5 sm:py-4 rounded-full font-black text-[13px] sm:text-[14px] shadow-2xl transition-all duration-300 z-[100] pointer-events-none tracking-tight flex items-center whitespace-nowrap",
