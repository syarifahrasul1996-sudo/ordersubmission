...
export function mapFirestoreDocToAppState(docId: string, data: any): AppState {
    ...
    return {
        ...
        price: data.price !== undefined && data.price !== null ? (typeof data.price === 'number' ? data.price : parseFloat(String(data.price).replace(/RM/gi, '').replace(/,/g, '')) || undefined) : undefined,
...
export function mapAppStateToFirestoreDoc(state: AppState) {
    ...
    return {
        ...
        price: state.price !== undefined && state.price !== null ? (typeof state.price === 'number' ? state.price : parseFloat(String(state.price).replace(/RM/gi, '').replace(/,/g, '')) || null) : null,
